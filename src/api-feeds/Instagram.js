        ...
        return(
            <div className="form">
              <form onSubmit={this.handleSubmit}>
                ...
                <input class="input" type="text" onChange={this.handleChange} placeholder="username"/>
                <input class="button" type="submit" value="Show Profile"/>
              </form>

              <div className="instafeed" onScroll={this.handleScroll}>
                {this.state.images.map((image) => {
                      return(
                        <div>
                          <p>
                            <a href='#' onClick={() => this.handleClick(image.node.shortcode)}>
                              <img className="instaimage" alt="" src={image.node.display_url} width={image.node.dimensions.width} height={image.node.dimensions.height} />
                            </a>
                          </p>
                          <FontAwesomeIcon icon={faHeart} className="heart"/>
                          <nobr className="likes"> by {image.node.edge_liked_by.count} people</nobr> <br/>
